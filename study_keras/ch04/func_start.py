...
additional_data = np.random.randint(low=2000, high=2017, size=(1000, 1))
labels = np.random.randint(low=1000,high=100000000, size=(1000, 1))

model.fit([headline_data, additional_data], [labels, labels], epochs=5, batch_size=64)

headline_data_test = np.random.randint(10000, size=(100, 100))
additional_data_test = np.random.randint(low=2000, high=2017, size=(100, 1))
labels_test = np.random.randint(low=1000,high=100000000, size=(100, 1))
